...
const restaurantList = [
    {
        ...
        "analytics": {
            "context": "seo-data-475ceedd-e122-453a-9fa8-efd5fac1c30a"
        },
        "cta": {
...
const Header = () => {
    return <div className="header">
        <div className="logo">
            <img src="https://marketplace.canva.com/EAFaFUz4aKo/2/0/1600w/canva-yellow-abstract-cooking-fire-free-logo-JmYWTjUsE-Q.jpg"></img>
        </div>
...
const Restaurant = (props) => {
    console.log(props);
    const {id, name, avgRating, cloudinaryImageId, costForTwo } = props.resData;
...
const mainContainer = <div className="main">
    <Header/>
    <Body/>
</div> 
